...
The library imports no Agent-Workflow runtime code and remains dependency-neutral. Library version `0.1.0` is recorded as verified with Agent-Workflow `0.10.1`, `0.11.0`, and `0.11.1` in `COMPATIBILITY.json`.
