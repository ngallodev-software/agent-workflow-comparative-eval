...
from .constants import (
    ...
    ORACLE_ADJUDICATION_SCHEMA, ORACLE_DISAGREEMENT_SET_SCHEMA,
    ORACLE_TIEBREAK_VIEW_SCHEMA, ORACLE_CONSENSUS_RESOLUTION_SCHEMA,
...
_SCHEMA_FILES = {
    ...
    ORACLE_ADJUDICATION_SCHEMA: "oracle-adjudication.schema.json",
    ORACLE_DISAGREEMENT_SET_SCHEMA: "oracle-disagreement-set.schema.json",
    ORACLE_TIEBREAK_VIEW_SCHEMA: "oracle-tiebreak-view.schema.json",
    ORACLE_CONSENSUS_RESOLUTION_SCHEMA: "oracle-consensus-resolution.schema.json",
